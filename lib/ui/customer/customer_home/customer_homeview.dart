...
class CustomerHomeView extends StackedView<CustomerHomeViewModel>{
  ...
  @override
  void onDispose(CustomerHomeViewModel viewModel) {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context , CustomerHomeViewModel viewModel) {
    return CustomAppBar(
        title: Padding(
  ...
  Widget toogleSwitch(bool isSelected , CustomerHomeViewModel viewModel){
    return Switch(
      ...
      inactiveThumbImage: AssetImage(ImageConstant.imgMdiTransitCon),
    );
  }

  Widget ordersWidget( BuildContext context){
    return SizedBox(
  ...
  Widget tripsWidget(BuildContext context , CustomerHomeViewModel viewModel ){
    return SizedBox(
      width: MediaQuery.sizeOf(context).width * 0.42,
      child: GestureDetector(
        onTap: () {
          locator<NavigationService>().navigateTo(Routes.customerTripHistoryView);
        },
        child: Container(
          padding: EdgeInsets.symmetric(
            horizontal: 23,
  ...
  Widget _buildOrderComponent(BuildContext context , CustomerHomeViewModel viewModel) {
    return Container(
      width: MediaQuery.sizeOf(context).width * 0.9,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          ordersWidget(context),
          tripsWidget(context , viewModel)
        ],
      ),
    );
  }
  ...
  FutureBuilder<tripModel.TripHistoryModel> getRecentTrips(CustomerHomeViewModel viewModel , int userID){
