...
class EditTripFormViewModel extends BaseViewModel{
  final productSpaceController =  TextEditingController(text: EditTripData.getInstance().luggageSpace );
  final commissionController =  TextEditingController(text:EditTripData.getInstance().commission );
